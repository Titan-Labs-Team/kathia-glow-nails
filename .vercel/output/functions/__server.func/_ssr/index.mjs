...
import { F as resolveManifestAssetLink, G as rootRouteId, o as getNormalizedURL, p as getOrigin, b as attachRouterServerSsrUtils, i as defineHandlerCallback, f as createSerializationAdapter, e as createRawStreamRPCPlugin, t as invariant, x as isNotFound, y as isRedirect, z as isResolvedRedirect, D as mergeHeaders, l as executeRewriteInput, h as defaultSerovalPlugins, C as makeSerovalPlugin, r as getStylesheetHref } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DI_FHjFr.mjs");
